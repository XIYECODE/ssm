      ...
      <div class="box box-success">
        <div class="box-body">
          ...
          <div id="toolbar"  class="btn-group">
            <a href="${pageContext.request.contextPath }/users/saveUI" type="button" class="btn bg-maroon btn-flat"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>添加</a>
            <button type="button" data-ope="delete" class="btn bg-olive btn-flat" id="del_user"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>删除</button>
          ...
          <table id="user_table" class="text-center"  data-show-jumpto="true"></table><!-- 如何将结果渲染到此处 -->
        </div>
      </div>
    </section>
    ...
    <script type="text/javascript">
        ...
        $(function(){
        	...
        	$("#toolbar > button").on("click", function(){
        		...
        		if("edit" == ope){
        			window.location.href = sys.contextPath+"/users/"+idArray[0]+"/editUI";// ${pageContext.request.contextPath}放在js中不好，当js代码从页面抽离出来时，就会失效
        		}else if("delete" == ope){
        			var ids = idArray.join(",");
        			request.ajax(sys.contextPath+"/users/"+ids, "_method=DELETE", true, function(){
        	...
        	//发送请求
        	 var queryUrl = 'http://localhost:8080/WebShopPlatform/users';
