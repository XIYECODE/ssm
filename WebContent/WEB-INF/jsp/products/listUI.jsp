...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
      ...
      <div class="box box-success">
        <div class="box-body">
          ...
          <%-- <div id="toolbar"  class="btn-group">
            <a href="${pageContext.request.contextPath }/products/saveUI" type="button" class="btn bg-maroon btn-flat"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>添加</a>
            <button type="button" data-ope="delete" class="btn bg-olive btn-flat" id="del_product"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>删除</button>
    ...
    <script src="${pageContext.request.contextPath}/static/js/product/product.js"></script>
  </body>
</html>
