      ...
      <div class="box box-success">
        <div class="box-body">
          ...
          <div id="toolbar"  class="btn-group">
          	<button type="button" data-ope="unforbid" class="btn bg-olive btn-flat hidden" id="unforbid"><span class="glyphicon glyphicon-ok-circle" aria-hidden="true"></span>解封</button>
          	<button type="button" data-ope="forbid" class="btn bg-danger btn-flat hidden" id="forbid"><span class="glyphicon glyphicon-ban-circle" aria-hidden="true"></span>封号</button>
