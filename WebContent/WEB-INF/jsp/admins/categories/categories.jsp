...
<style>  
	.menu {width:40%; background:#0099FF; font-size:14px; font-family: "微软雅黑";float:left;}  
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/admin/categories.js"></script>
</body>
</html>