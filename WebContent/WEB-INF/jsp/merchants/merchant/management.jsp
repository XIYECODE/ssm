...
<body class="hold-transition skin-blue sidebar-mini" style="overflow:hidden;">
             ...
             <ul class="nav navbar-nav">
                 <li class="dropdown user user-menu">
                     ...
                     <ul class="dropdown-menu pull-right">
                         <li><a class="menuItem" data-id="91" href="${pageContext.request.contextPath }/merchants/merchant/info"><i class="fa fa-user"></i>个人信息</a></li>
  ...
  <script src="${pageContext.request.contextPath }/static/js/merchant/index.js"></script>
</body>
</html>