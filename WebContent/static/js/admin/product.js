...
$(function(){
	...
	//发送请求
	 var queryUrl = sys.contextPath +'/admins/products/unPass/list';
	 request.ajax(sys.contextPath +'/admins/products/unPass/getList', "", true, function(data){
...
$("body").on("change", "#registerTime", function(){
	...
	//var url = sys.contextPath + "/admins/products/unPass/list";
	$("#product_table").bootstrapTable('refresh', {query:param});
});


function getMoreAttribute (id){
	var url = sys.contextPath + "/admins/products/unPass/"+id;
